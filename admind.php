...
.modal-box{background:#0d1628;border:1px solid rgba(212,160,23,.3);border-radius:20px;width:100%;max-width:720px;max-height:90vh;overflow-y:auto;box-shadow:0 30px 80px rgba(0,0,0,.7);}
...
.pc-template-wrap{
    ...
    min-height:1123px;width:100%;position:relative;display:flex;flex-direction:column;
}
/* .pc-inner{padding:148px 48px 120px;flex:1;display:flex;flex-direction:column;gap:14px;} */

/* 16-05-2026 */
/* .pc-inner{padding:148px 48px 120px 72px;flex:1;display:flex;flex-direction:column;gap:14px;} */
.pc-inner{padding:130px 40px 100px 72px;flex:1;display:flex;flex-direction:column;gap:16px;}


/* 16-05-2026 */
/* .pc-hero{display:flex;align-items:flex-start;gap:22px;margin-bottom:6px;}
.pc-hero-photo{width:100px;height:110px;object-fit:cover;border-radius:10px;border:2px solid rgba(180,140,10,.45);flex-shrink:0;box-shadow:0 4px 18px rgba(0,0,0,.15);}
.pc-hero-photo-ph{width:100px;height:110px;border-radius:10px;background:linear-gradient(135deg,#f5e8c0,#e8d090);border:2px solid rgba(180,140,10,.35);display:flex;align-items:center;justify-content:center;font-size:2.8rem;flex-shrink:0;}
.pc-hero-text{flex:1;padding-top:4px;}
.pc-hero-label{font-size:.58rem;letter-spacing:.2em;text-transform:uppercase;color:#a07820;font-weight:700;margin-bottom:4px;}
.pc-hero-name{font-family:'Playfair Display',serif;font-size:1.9rem;color:#1a1220;line-height:1.1;margin-bottom:3px;}
...
.pc-hero-badge{background:rgba(180,140,10,.1);border:1px solid rgba(180,140,10,.3);color:#7a5c10;border-radius:5px;padding:2px 10px;font-size:.66rem;font-weight:600;font-family:'DM Sans',sans-serif;} */

/* 160 , 185 - large */
.pc-hero{display:flex;align-items:center;gap:28px;margin-bottom:10px;background:rgba(255,252,240,0.6);border:1px solid rgba(180,140,10,.18);border-radius:14px;padding:20px 24px;}
.pc-hero-photo{width:130px;height:150px;object-fit:cover;border-radius:12px;border:3px solid rgba(180,140,10,.5);flex-shrink:0;box-shadow:0 8px 28px rgba(0,0,0,.18);}
.pc-hero-photo-ph{width:130px;height:150px;border-radius:12px;background:linear-gradient(135deg,#f5e8c0,#e8d090);border:3px solid rgba(180,140,10,.4);display:flex;align-items:center;justify-content:center;font-size:3.5rem;flex-shrink:0;box-shadow:0 8px 28px rgba(0,0,0,.12);}
.pc-hero-text{flex:1;padding-top:0;}
.pc-hero-label{font-size:.6rem;letter-spacing:.22em;text-transform:uppercase;color:#a07820;font-weight:700;margin-bottom:8px;}
.pc-hero-name{font-family:'Playfair Display',serif;font-size:2.1rem;color:#1a1220;line-height:1.1;margin-bottom:6px;}
.pc-hero-nick{font-size:.85rem;color:#7a6030;font-style:italic;margin-bottom:12px;}
.pc-hero-badges{display:flex;flex-wrap:wrap;gap:7px;}
.pc-hero-badge{background:rgba(180,140,10,.12);border:1px solid rgba(180,140,10,.35);color:#7a5c10;border-radius:6px;padding:4px 12px;font-size:.68rem;font-weight:700;font-family:'DM Sans',sans-serif;letter-spacing:.04em;}





.pc-divider{border:none;border-top:1px solid rgba(180,140,10,.25);margin:2px 0;}
.pc-info-grid{display:grid;grid-template-columns:1fr 1fr;border:1px solid rgba(180,140,10,.2);border-radius:8px;overflow:hidden;background:rgba(255,252,240,.7);}
...
.pc-info-lbl{font-size:.56rem;text-transform:uppercase;letter-spacing:.13em;color:#a07820;font-weight:700;margin-bottom:2px;}
.pc-info-val{font-size:.82rem;color:#1a1220;line-height:1.4;}
.pc-exam-pill{display:inline-block;background:rgba(180,140,10,.12);border:1px solid rgba(180,140,10,.3);color:#7a5c10;border-radius:4px;padding:1px 8px;font-size:.65rem;margin:1px 2px 1px 0;font-family:'DM Sans',sans-serif;}
.pc-op-section{margin-top:4px;}
.pc-op-heading{font-family:'Playfair Display',serif;font-size:.95rem;color:#1a1220;display:flex;align-items:center;gap:8px;margin-bottom:4px;}
.pc-op-heading em{color:#a07820;font-style:italic;}
.pc-op-count-pill{background:rgba(180,140,10,.12);border:1px solid rgba(180,140,10,.25);color:#a07820;border-radius:20px;padding:1px 10px;font-size:.62rem;font-weight:700;font-family:'DM Sans',sans-serif;font-style:normal;}
.pc-op-bar{width:36px;height:3px;background:#c8a020;border-radius:2px;margin-bottom:10px;}
.pc-op-card{background:rgba(255,252,240,.75);border:1px solid rgba(180,140,10,.18);border-radius:8px;padding:10px 14px;margin-bottom:8px;position:relative;}
.pc-op-card:last-child{margin-bottom:0;}
.pc-op-card::before{content:'\201C';position:absolute;top:4px;right:12px;font-size:2.5rem;line-height:1;color:rgba(180,140,10,.12);font-family:Georgia,serif;}
.pc-op-author-row{display:flex;align-items:center;gap:8px;margin-bottom:6px;}
.pc-op-ava{width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#D4A017,#F5C842);display:flex;align-items:center;justify-content:center;font-size:.7rem;font-weight:700;color:#0d1628;flex-shrink:0;}
...
.pc-op-text {font-size:.78rem;color:#3a3040;line-height:1.65;font-style:italic;}
.pc-op-empty{text-align:center;padding:20px 12px;color:#aaa;font-size:.78rem;background:rgba(255,252,240,.5);border:1px dashed rgba(180,140,10,.2);border-radius:8px;}

/* Left sidebar for branch + logo */
/* .pc-left-sidebar {
    position: absolute;
    left: 0;
    top: 0;
    ...
    border-right: 1px solid rgba(180,140,10,.18);
    padding: 20px 0;
} */
.pc-left-sidebar{position:absolute;left:0;top:0;bottom:0;width:54px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;background:rgba(255,252,240,0.6);border-right:1px solid rgba(180,140,10,.2);padding:16px 0;}
.pc-branch-label {
...
/* .pc-logo-seal{width:42px;height:42px;border-radius:50%;border:2px solid rgba(180,140,10,.4);background:#fff;display:flex;align-items:center;justify-content:center;font-size:.48rem;font-weight:800;color:#7a5c10;text-align:center;letter-spacing:.03em;line-height:1.25;padding:2px;font-family:'DM Sans',sans-serif;overflow:hidden;flex-shrink:0;}
.pc-logo-seal img{width:38px;height:38px;object-fit:contain;border-radius:50%;} */
.pc-logo-seal{width:44px;height:44px;display:flex;align-items:center;justify-content:center;font-size:.48rem;font-weight:800;color:#7a5c10;text-align:center;letter-spacing:.03em;line-height:1.25;font-family:'DM Sans',sans-serif;flex-shrink:0;}
.pc-logo-seal img{width:44px;height:44px;object-fit:contain;}
    ...
    <div class="content">
      ...
      <div id="charts">
        ...
        <div class="charts-row">
          ...
          <div class="chart-card">
            <h3>Exit Feedback Analytics - Overall</h3>
          ...
          <div class="chart-card">
            <h3>Exit Feedback Analytics - Section-wise </h3>
...
function updateFullySelectedCount() {
    var total   = document.querySelectorAll('.fully-row-check').length;
    var checked = document.querySelectorAll('.fully-row-check:checked').length;
...
function renderFullyTable(){
    ...
    '<th>#</th><th>Reg No</th><th>Name</th><th>Level</th><th>Program</th><th>Department</th><th>Branch</th><th>Year</th><th>Slambook Done</th><th>Feedback Done</th><th>Actions</th>' +
    '</tr></thead><tbody>';
    ...
    for (var i = 0; i < slice.length; i++) {
        ...
        html += '<tr>' +
          '<td style="text-align:center;"><input type="checkbox" class="fully-row-check row-checkbox" checked data-row=\'' + rowJson + '\' onchange="onFullyRowCheck(this)"></td>' +
        ...
        '<td>' + (parseInt(r.details_done)===1 && parseInt(r.reflect_done)===1 ? '<span class="section-badge ok">&#10003; Yes</span>' : '<span class="section-badge no">&#10007; No</span>') + '</td>' +
'<td>' + (parseInt(r.feedback_done)===1 ? '<span class="section-badge ok">&#10003; Yes</span>' : '<span class="section-badge no">&#10007; No</span>') + '</td>' +
...
function renderPartialTable(){
    ...
    for (var i = 0; i < slice.length; i++) {
        ...
        html += '<tr>' +
          '<td style="text-align:center;"><input type="checkbox" class="partial-row-check row-checkbox" checked data-row=\'' + rowJson + '\' onchange="onPartialRowCheck(this)"></td>' +
          '<td class="num">' + (start+i+1) + '</td>' +
          '<td class="mono">' + esc(r.regno) + '</td>' +
          '<td>' + (esc(r.name)||'<span style="color:var(--muted)">&mdash;</span>') + '</td>' +
          '<td><span class="badge-gold">' + (esc(r.bm)||'&mdash;') + '</span></td>' +
...
var _branchSide = v('branch') || v('department') || v('bm') || '';
    var _logoSeal = '<div class="pc-logo-seal"><img src="vignan_logo1.svg" crossorigin="anonymous" onerror="this.outerHTML=\'VIGNAN\'"></div>';

    var photo = d.photo_path
        ? '<img class="pc-hero-photo" src="' + _e(d.photo_path) + '" alt="Photo" crossorigin="anonymous" onerror="this.outerHTML=\'<div class=\\\'pc-hero-photo-ph\\\'>&#128100;</div>\'">'
    ...
    if (d.exam) {
        ...
        for (var ei = 0; ei < exams.length; ei++) {
            ...
            if (et) examHTML += '<span class="pc-exam-pill">' + _e(et) + '</span>';
        }
    }
    ...
    if (d.opinions && d.opinions.length) {
        for (var oi = 0; oi < d.opinions.length; oi++) {
            ...
            var nameParts = (op.author_name || op.author_id || '?').split(' ').slice(0,2);
            var initials = '';
            for (var ni = 0; ni < nameParts.length; ni++) initials += (nameParts[ni][0] || '').toUpperCase();
            opinionsHTML += '<div class="pc-op-card">' +
                '<div class="pc-op-author-row">' +
                    '<div class="pc-op-ava">' + _e(initials) + '</div>' +
                    '<div>' +
                        '<span class="pc-op-aname">' + _e(op.author_name || op.author_id) + '</span>' +
                        '<span class="pc-op-aid">' + _e(op.author_id) + '</span>' +
                    '</div>' +
                '</div>' +
                '<div class="pc-op-text">' + _e(op.opinion) + '</div>' +
            '</div>';
        }
    } else {
        opinionsHTML = '<div class="pc-op-empty">No opinions written yet.</div>';
    }

    var opCount = (d.opinions || []).length;

//     return '<div class="pc-template-wrap">' +
//   '<div class="pc-inner">' +
var branchDisplay = v('branch') || v('department') || v('bm') || '';
    var logoImg = '<div class="pc-logo-placeholder">VU</div>';
    // If you have a logo path, use: '<div class="pc-logo-wrap"><img src="vignan_logo.png" crossorigin="anonymous"></div>'

   return '<div class="pc-template-wrap">' +
  '<div class="pc-left-sidebar">' +
    (_branchSide ? '<div class="pc-branch-label">' + _e(_branchSide) + '</div>' : '') +
    _logoSeal +
  '</div>' +
  '<div class="pc-inner">' +
    ...
    '<div class="pc-hero">' +
      ...
      '<div class="pc-hero-text">' +
        '<div class="pc-hero-label">Vignan\'s University &middot; Slam Book</div>' +
        '<div class="pc-hero-name">' + (v('name') || '&mdash;') + '</div>' +
        (d.nickname ? '<div class="pc-hero-nick">&ldquo; ' + v('nickname') + ' &rdquo;</div>' : '') +
        '<div class="pc-hero-badges">' +
          (d.bm      ? '<span class="pc-hero-badge">' + v('bm') + '</span>'      : '') +
          (d.program ? '<span class="pc-hero-badge">' + v('program') + '</span>' : '') +
          (d.branch  ? '<span class="pc-hero-badge">' + v('branch') + '</span>'  : '') +
          (d.year    ? '<span class="pc-hero-badge">Batch ' + v('year') + '</span>' : '') +
        '</div>' +
      '</div>' +
    '</div>' +
    '<hr class="pc-divider">' +
    '<div class="pc-info-grid">' +
      (d.regno     ? '<div class="pc-info-item"><div class="pc-info-lbl">Reg. Number</div><div class="pc-info-val">' + v('regno') + '</div></div>' : '') +
      (d.dob       ? '<div class="pc-info-item"><div class="pc-info-lbl">Date of Birth</div><div class="pc-info-val">' + v('dob') + '</div></div>' : '') +
      (d.mobile    ? '<div class="pc-info-item"><div class="pc-info-lbl">Mobile</div><div class="pc-info-val">' + v('mobile') + '</div></div>' : '') +
      (d.alt_mobile? '<div class="pc-info-item"><div class="pc-info-lbl">Alt. Mobile</div><div class="pc-info-val">' + v('alt_mobile') + '</div></div>' : '') +
      (d.department? '<div class="pc-info-item"><div class="pc-info-lbl">Department</div><div class="pc-info-val">' + v('department') + '</div></div>' : '') +
      (d.year      ? '<div class="pc-info-item"><div class="pc-info-lbl">Batch Year</div><div class="pc-info-val">' + v('year') + '</div></div>' : '') +
      (d.company   ? '<div class="pc-info-item"><div class="pc-info-lbl">Company / Plans</div><div class="pc-info-val">' + v('company') + '</div></div>' : '') +
      (d.location  ? '<div class="pc-info-item"><div class="pc-info-lbl">Location</div><div class="pc-info-val">' + v('location') + '</div></div>' : '') +
      (d.exam      ? '<div class="pc-info-item pc-full"><div class="pc-info-lbl">Competitive Exams</div><div class="pc-info-val">' + examHTML + '</div></div>' : '') +
      (d.fav       ? '<div class="pc-info-item pc-full"><div class="pc-info-lbl">Favourites / Hobbies</div><div class="pc-info-val">' + v('fav') + '</div></div>' : '') +
      (d.extra     ? '<div class="pc-info-item pc-full"><div class="pc-info-lbl">Extra Curriculars / Achievements</div><div class="pc-info-val">' + v('extra') + '</div></div>' : '') +
    '</div>' +
    '<hr class="pc-divider">' +
    '<div class="pc-op-section">' +
      '<div class="pc-op-heading">Friends\' <em>Opinions</em><span class="pc-op-count-pill">' + opCount + ' note' + (opCount!==1?'s':'') + '</span></div>' +
...
var _bl = holder.querySelector('.pc-branch-label');
    if (_bl && holder.id === 'pdf-render-holder') {
        var _text = _bl.textContent || '';
        _bl.style.writingMode = 'horizontal-tb';
        _bl.style.transform = 'none';
        _bl.style.display = 'flex';
        _bl.style.flexDirection = 'column';
        _bl.style.alignItems = 'center';
        _bl.style.letterSpacing = '0';
        _bl.innerHTML = _text.split('').map(function(ch) {
            return '<span style="display:block;line-height:1.2;font-family:\'Playfair Display\',serif;font-weight:700;color:#5a4010;font-size:2rem;text-transform:uppercase;">' + ch + '</span>';
        }).join('');
    }
    return new Promise(function(resolve, reject) {
        setTimeout(function() {
            var cardEl = holder.querySelector('.pc-template-wrap');
...
function bulkDownloadZip() {
    var checkedCbs = document.querySelectorAll('.fully-row-check:checked');
    if (!checkedCbs.length) { alert('No students selected. Please check at least one student.'); return; }
    var students = [];
    for (var i = 0; i < checkedCbs.length; i++) {
        try { students.push(JSON.parse(checkedCbs[i].getAttribute('data-row'))); } catch(e) {}
    }
...
function exportToExcelFully() {
    var checkedCbs = document.querySelectorAll('.fully-row-check:checked');
    if (!checkedCbs.length) { alert('No students selected.'); return; }
    var students = [];
    for (var i = 0; i < checkedCbs.length; i++) {
        try { students.push(JSON.parse(checkedCbs[i].getAttribute('data-row'))); } catch(e) {}
    }
    ...
    for (var i = 0; i < students.length; i++) {
        ...
        rows.push({
            ...
            'Slambook Done': (parseInt(r.details_done)===1 && parseInt(r.reflect_done)===1)?'Yes':'No',
    ...
    ws['!cols'] = [{wch:5},{wch:15},{wch:28},{wch:10},{wch:16},{wch:32},{wch:22},{wch:12},{wch:14},{wch:14},{wch:14},{wch:14}];
...
function exportToExcelPartial() {
    var checkedCbs = document.querySelectorAll('.partial-row-check:checked');
    if (!checkedCbs.length) { alert('No students selected.'); return; }
    var students = [];
    for (var i = 0; i < checkedCbs.length; i++) {
        try { students.push(JSON.parse(checkedCbs[i].getAttribute('data-row'))); } catch(e) {}
