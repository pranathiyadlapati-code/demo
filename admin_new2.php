...
.bs-mast-sub{
  ...
  /* CHANGE 2: center-align and larger font for "Class of YEAR" */
...
/* CHANGE 3: larger font and bigger box for bs-tag */
.bs-tag{
...
/* right sidebar */
/* CHANGE 4: photo height increased to stretch down to batch year */
...
function buildProfileHTML(d) {
    ...
    // ── Opinions
    // CHANGE 6: only render opinions section if there are opinions
    ...
    // If opCount === 0, opinionsBlock stays empty — section is fully hidden

    // ── Right sidebar
    // CHANGE 4: photo height increased (220px → 310px) so it stretches parallel to batch year
    // CHANGE 5: mobile and alt_mobile removed from sidebar
...
if (d.branch || d.department) sidebar += '<div class="bs-rs-batch"><div class="bs-rs-batch-lbl">Branch</div><div class="bs-rs-batch-val" style="font-size:1.3rem;letter-spacing:.06em;font-weight:900;text-align:center;display:block;line-height:1.2;margin-top:4px;">' + (v('branch') || v('department')) + '</div></div>';
    ...
    return (
        '<div class="bs-card">' +
          '<div class="bs-inner">' +
'<img src="logo1.svg.jpeg" crossorigin="anonymous" alt="Vignan Logo" style="position:absolute;top:110px;left:50px;width:164px;height:164px;object-fit:contain;" onerror="this.style.display=\'none\'">' +
            // Stamp
            '<div class="bs-stamp">' +
            ...
            // CHANGE 1: logo moved to LEFT of title, CHANGE 2: "Class of" centered + larger
            '<div class="bs-masthead">' +
              ...
              '<div class="bs-mast-title-row" style="display:flex;align-items:center;justify-content:center;gap:14px;">' +
                // '<img src="logo1.svg" crossorigin="anonymous" alt="Vignan Logo" style="width:64px;height:64px;object-fit:contain;flex-shrink:0;" onerror="this.style.display=\'none\'">' +
